        ...
        <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          >
            ...
            <div className="flex flex-col flex-1 p-6 sm:p-8">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {['Timed Reveals', 'Mic Detection', 'Audio Playback'].map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full bg-[hsl(var(--bg-surface))] border border-[hsl(var(--border-subtle))] px-2.5 py-1 text-[10px] font-body font-medium text-[hsl(var(--text-muted))] uppercase tracking-wider"
                  >
                    {tag}
                  </span>
                ))}
          ...
          >
            ...
            <div className="flex flex-col flex-1 p-6 sm:p-8">
              ...
              {/* Features */}
              <div className="flex flex-wrap gap-2 mb-6">
                {['Metronome', 'Key & Scale', 'Custom Progressions'].map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full bg-[hsl(var(--bg-surface))] border border-[hsl(var(--border-subtle))] px-2.5 py-1 text-[10px] font-body font-medium text-[hsl(var(--text-muted))] uppercase tracking-wider"
                  >
